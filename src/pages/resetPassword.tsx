...
import { ArrowLeft, Mail, Loader2, KeyRound, CheckCircle } from 'lucide-react';
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-lg border border-white/10 p-8 mb-8">
                <div className="text-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <Link
                      to="/signin"
                      className="block w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-3 rounded-lg font-semibold text-center transition-all duration-300 transform hover:scale-105"
                    >
                      Back to Sign In
                    </Link>
                  </div>
